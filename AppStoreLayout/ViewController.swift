...
//                let headerItemSize = NSCollectionLayoutSize(widthDimension: .fractionalWidth(92), heightDimension: .estimated(44))
//                let headerItem = NSCollectionLayoutBoundarySupplementaryItem(layoutSize: headerItemSize, elementKind: SupplementaryViewKind.header, alignment: .top)
...
//                headerItem.contentInsets = NSDirectionalEdgeInsets(top: 0, leading: 4, bottom: 0, trailing: 4)
    ...
    func configureDataSource() {
       // fatalError("TODO: Create Data Source")
        ...
        let essentialSection = Section.standard("Essentials")
